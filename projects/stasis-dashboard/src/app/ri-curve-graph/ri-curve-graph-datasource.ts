...
export interface RiCurveGraphItem {
  x: number;
  y: number;
}

// TODO: replace this with real data from your application
const EXAMPLE_DATA: RiCurveGraphItem[] = [
  {
 ...
 */
export class RICurveGraphDataSource extends DataSource<RiCurveGraphItem> {
  data: RiCurveGraphItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<RiCurveGraphItem[]> {
